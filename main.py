...
def get_args_parser():
    ...
    parser.add_argument('--patch_vit', default=False, action='store_true')
    ...
    parser.add_argument("--pool_size", nargs="*", default=['_', '_', '_', '_', 30, 30],
    ...
    parser.add_argument("--enc_pool_size", nargs="*",
                        default=['_', '_', '_', '_', '_', '_', '_', '_', '_', '_', 30, 30],
...
def main(args):
    ...
    elif args.lr_scheduler == 'gradual_cosine_warm_restart':
